...
class KapalController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Kapal']))
		{
			...
			if($model->save()){
				$messageType = 'success';
	            $message = "<strong>Well done!</strong> You successfully add data ";
	...
	{$model = new Kapal('search');
        ...
        $columns=array(
        	array(
        		'type'=>'html',
        		'name'=>'nama_kapal',
        		'value'=>'CHtml::link($data->nama_kapal,Yii::app()->controller->createUrl("view",array("id"=>$data->id)))',
        		),
        	array(
        		'type'=>'html',
        		'name'=>'pelayaran',
	 ...
	 * @param Kapal $model the model to be validated
	 */
