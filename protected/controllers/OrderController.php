...
class OrderController extends YiishopController
{
	/**
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','inject_order'),
				'users'=>array('*'),
			),
	...
	public function actionInject_order($kode_member){
	//looping brg
	...
	public function actionCreate()
	{
		...
		try{
			...
			$model->order_code = $order_code = $model->kode_member. '' . $this -> orderCode();
